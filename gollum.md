...
| gitのCommandLineToolへの依存 | 小 | gitをCommandLineToolの一部としてインストールしているため、<br>OSの更新の度に再セットアップが必要になる。 | 再セットアップ方法については[明記](http://localhost:4567/git)すること。<br>開発者ツールから独立にgitをインストールすることを検討すること。 |
