...
| 課題 | 優先度 | 説明 | ステータス |
---|---|---|---
| インライン数式モード | 中 | インラインでの数式モードの使用方法が知りたい。 | 要調査 |
| 色分 | 中 | markdown記法での色分機能と、実用的な使用方法が知りたい。 | 要調査 |
| gitの開発者ツールへの依存 | 小 | gitを開発者ツールの一部としてインストールしているため、<br>OSの更新の度に再セットアップが必要になる。 | 開発者ツールから独立にgitをインストールすることを検討する。 |
| スリープモードによるgollumの停止 | 小 | スリープモードになるとgollumが停止する。 | nohapで実行することを検討する。 |
